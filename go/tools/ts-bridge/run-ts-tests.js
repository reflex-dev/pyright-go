...
export function report() {
    ...
    if (substantivePasses + vacuousPasses > 0 && vacuousPasses > 0) {
        console.log(
            '  of the passes, ' +
                substantivePasses +
...
if (testFiles.some((name) => /^(typeEvaluator\d*|checker)\.test\.ts$/.test(name))) {
